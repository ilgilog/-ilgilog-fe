                        ...
                        <div className="flex justify-between items-center px-5 pt-5 border-t-[1px] border-solid border-gray-400">
                            {!isPoint ? 
                                <span className="flex justify-between items-center w-[30%]">
                                    <input type="checkbox" id={`like-${item?.uid}`} name="favorite-checkbox" checked={item?.likeStatus === 1} onChange={() => handleLike(item?.uid, item?.likeStatus)} value="favorite-button" className="favorite-input" />
