...
export const NoticeCont = () => {
    ...
    const noticeDummy = [
        ...
        },
        {
            ...
            content: "저희는 새로운 기능과 개선된 서비스로 여러분에게 더 나은 경험을 제공하기 위해 노력하고 있습니다. 이에 따라 다음과 같은 내용으로 업데이.\n버그 수정:\n이전 버전에서 발견된 일부 버그들을 수정하여 서비스의 안정성을 향상시켰습니다.\n업데이트 일정은 다음과 같습니다:\n일자: MM월 DD일 (월요일)\n시간: 오전 HH:MM\n본 업데이트로 인해 일시적와 너그러운 이해를 부탁드립니다. \n감사합니다.",
            date: "2024.03.15",
            new: true
        },
        {
                            ...
                            <AccordionItemButton>
                                <div className="flex items-center">
                                    ...
                                    <h3 className="text-xl ml-3">
                                        {item?.title}
                                        {item?.new === true && <span className="text-lg font-black text-white bg-red-500 px-1.5 ml-1 rounded-lg">N</span>}
                                    </h3>
